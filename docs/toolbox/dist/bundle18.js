...
window.__pkg__bundleSrc__['190']=function(){
    ...
    // 保存
    save: function () {
        return window.__pkg__getLazyBundle('./dist/bundle56.js','191')
    },

    // 立方体
    geometry: function () {
        return window.__pkg__getLazyBundle('./dist/bundle57.js','192')
    }
...
window.__pkg__bundleSrc__['193']=function(){
    ...
    // 立方体
    geometry: function () {
        return window.__pkg__getLazyBundle('./dist/bundle58.js','194')
    },

    // 修改器
    modify: function () {
        return window.__pkg__getLazyBundle('./dist/bundle59.js','195')
    }
