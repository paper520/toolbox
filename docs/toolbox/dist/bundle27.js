...
window.__pkg__bundleSrc__['265']=function(){
    ...
    // 键盘练习
    "keyboard": function () {
        return window.__pkg__getLazyBundle('./dist/bundle67.js','266')
    },

    // 英文打字
    "english": function () {
        return window.__pkg__getLazyBundle('./dist/bundle68.js','267')
    },

    // 拼音打字
    "pinyin": function () {
        return window.__pkg__getLazyBundle('./dist/bundle69.js','268')
    }
};
