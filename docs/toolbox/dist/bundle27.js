...
window.__pkg__bundleSrc__['273']=function(){
    ...
    // 键盘练习
    "keyboard": function () {
        return window.__pkg__getLazyBundle('./dist/bundle75.js','274')
    },

    // 英文打字
    "english": function () {
        return window.__pkg__getLazyBundle('./dist/bundle76.js','275')
    },

    // 拼音打字
    "pinyin": function () {
        return window.__pkg__getLazyBundle('./dist/bundle77.js','276')
    }
};
